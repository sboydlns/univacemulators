...
type
  TTokenType = ( ttIdentifier = 0, ttInteger, ttReal, ttEof, 
                 ...
                 ttIf, ttFor, ttColon, ttRead, ttWrite, ttUnknown );
...
const
  ReservedWords: array [0..44] of TReservedWord = (
    ...
    ( ID: 'REAL2'; TokenType: ttDeclarator ),
    ...
    ( ID: 'READ'; TokenType: ttRead ),
    ( ID: 'WRITE'; TokenType: ttWrite )
  );
{ TTokenGen }
