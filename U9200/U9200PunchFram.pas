...
uses
  ...
  Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.Samples.Gauges, U9200Punch;

type
  TU9200PunchFrame = class(TFrame)
    Label63: TLabel;
    PunchInput: TGauge;
    PunchOutput1: TGauge;
    Label66: TLabel;
  ...
  public
    constructor Create(AOwner: TComponent;  pun: TU92Punch); reintroduce;
...
uses U9200Types, EmulatorTypes, CardFile, LoadCardsFrm;

{ TU9200PunchFrame }

constructor TU9200PunchFrame.Create(AOwner: TComponent; pun: TU92Punch);
begin
...
destructor TU9200PunchFrame.Destroy;
begin
    inherited;
end;

procedure TU9200PunchFrame.DoPunchFeed(Sender: TObject);
begin
...
procedure TU9200PunchFrame.FrameResize(Sender: TObject);
begin
...
procedure TU9200PunchFrame.PunchEmptyBtnClick(Sender: TObject);
begin
    FPunch.EmptyHoppers;
...
procedure TU9200PunchFrame.PunchLoadBtnClick(Sender: TObject);
begin
...
procedure TU9200PunchFrame.SaveHopper1BtnClick(Sender: TObject);
begin
...
procedure TU9200PunchFrame.SaveHopper2BtnClick(Sender: TObject);
begin
    if (SaveDlg.Execute) then
    begin
